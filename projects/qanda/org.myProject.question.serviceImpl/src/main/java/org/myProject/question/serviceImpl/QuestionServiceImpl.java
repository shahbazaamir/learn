...
import org.myProject.question.serviceImpl.db.BasicDAO;
...
public class QuestionServiceImpl extends QuestionServiceImplOld{

	
	
	public void saveQuestionDetails(QuestionDetail questionDetail) throws QuestionException {
		BasicDAO basicDao =new BasicDAO();
		basicDao.saveDetails(questionDetail,"question");
