...
<title>Bank Modify</title>
</head>
<body>
<form id="bankModify" action="/Consulting/CommonController" method="post">
	<div class="addBox" >
	<div>
	<table>
	<tr>
		...
		<tr>
			<td  >Bank Name</td><td><input type="text" name="bankName" id="bankName"></td>
		</tr>
		<tr>
		...
		<tr>
			<td>
				...
				<input type="hidden" name="requestId" value="BankModify" >
